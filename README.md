...
1. Install dependencies:
   `npm install`
2. Set the `GEMINI_API_KEY` and `FEDAPAY_SECRET_KEY` (or `FEDAPAY_API_KEY`) in [.env.local](.env.local) to your FedaPay keys.
   - `GEMINI_API_KEY="MY_GEMINI_API_KEY"`
   - `FEDAPAY_SECRET_KEY="sk_sandbox_LwVmcEWjbq-tJADpe4THvoNQ"`
   - `FEDAPAY_API_KEY="sk_sandbox_LwVmcEWjbq-tJADpe4THvoNQ"`
