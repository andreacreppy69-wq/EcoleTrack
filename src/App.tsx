...
const FR = {
  ...
  profileMenuAccount: "Mon compte",
  editProfile: "Éditer le profil",
  logout: "Déconnexion",
  user: "Utilisateur",
  profileImageAlt: "Aperçu profil",
  profileImagePreviewAlt: "Aperçu du profil",
  profileEditTitle: "Édition de profil",
  profileEditHeading: "Modifier vos informations",
  profilePhotoLabel: "Photo de profil (optionnelle)",
  saveProfileButton: "Enregistrer le profil",
  paymentResultTitle: "Résultat de paiement :",
  brandTagline: "Mécénat Éducatif",
  investNowButton: "Investir dès maintenant",
  heroFeatureLabel: "Projet d’Impact Social National",
  heroHeading: "Investissez dans l’avenir de l’éducation avec l’Application de suivi scolaire en temps réel.",
  ...
  heroTrustedLabel2: "Zéro coupure réseau",
  heroQuote: "Rejoignez-nous pour transformer l’éducation en Afrique. Votre investissement n’est pas seulement financier, il est social et durable.",
  footerCompanyName: "Ecole Track Afrique",
  footerCopyright: "© 2026 AYISSOU Koffi Elom. Tous Droits Réservés.",
  footerEncryptedData: "Données cryptées SSL",
  footerSandbox: "Simulateur Sandbox local",
  openWhatsApp: "Ouvrir WhatsApp",
  loginTitle: "Se connecter",
  loginSubtitle: "Connectez-vous avec votre email et mot de passe. La création de compte est réservée à l’administrateur.",
  ...
  adminDashboardDescription: "Connectez-vous pour gérer les comptes utilisateurs et suivre les connexions.",
  adminEmailLabel: "Email administrateur",
  adminPasswordLabel: "Mot de passe",
  adminLoginButton: "Se connecter en tant qu'admin",
  passwordChangeTitle: "Changement de mot de passe",
  passwordChangeSubtitle: "Vous devez changer votre mot de passe avant de pouvoir accéder au site.",
  passwordChangeSubmit: "Valider le nouveau mot de passe",
                      ...
                      <div className="grid grid-cols-2 gap-6 items-start">
                        <div>
                          ...
                          <div className="mt-4 pt-4 border-t border-slate-700">
                            <span className="text-[10px] uppercase tracking-[0.2em] text-slate-500 font-semibold whitespace-pre-line">Investisseurs</span>
                        ...
                        <div>
                          ...
                          <div className="mt-4 pt-4 border-t border-slate-700">
                            <span className="text-[10px] uppercase tracking-[0.2em] text-slate-500 font-semibold whitespace-pre-line">Donateurs</span>
                            <div className="mt-1 text-xl font-bold text-white">{displayedDonationCount}</div>
                          </div>
                        </div>
                      </div>
                    </div>
